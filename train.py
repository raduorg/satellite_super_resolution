...
Usage:
    python main.py --model edsr --epochs 100 --n-feats 64 --n-resblocks 16 --augmentation flip_rotate
    python main.py --model mlp --epochs 100 --mlp-embed-dim 256 --mlp-n-layers 8
"""
...
class SRDataset(Dataset):
    def __init__(self, csv_path, root_dir, with_target=True, augmentation=None):
    ...
    def _apply_augmentation(self, lr, hr):
        """Apply same augmentation to both LR and HR"""
